...
const Home = () => {
  ...
  const attackEnemy = useCallback(() => {
    ...
    setTimeout(() => {
      setCombatState(prev => {
        ...
        const attackMessage = `Kaito attacks for ${10 + weaponDamage + traitBonus} damage!`;
        const newLog = [...prev.log, attackMessage];
      ...
      setTimeout(() => {
        setCombatState(prev => {
          ...
          if (newEnemyHealth <= 0) {
            ...
            updateXP(prev.enemy.gold * 10);
            updateSkillLevel(selectedSkill.name);
  ...
  }, [combatState, player.equipment, player.recipes, player.trait, updateXP, player.skills, completeQuest, completeDailyTask, updateSkillLevel]);
              ...
              <div className="mt-3 text-center">
                ...
                {player.skills.map(skill => (
                  <Button
                    ...
                    onClick={() => attackEnemy()} // Simplified; assumes attackEnemy handles skill logic
